...
<script type="text/javascript" src="resources/system/presentrecord/presentrecordrefuse.js"></script>
	...
	<div class="bootstrap-form">
		...
		<form role="form" class="form-horizontal" id="presentrecordForm" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="control-label col-xs-3 form-lable">拒绝理由：</label>
				<div class="col-xs-9">
			...
			<div class="form-group form-group-button">
				...
				<div class="col-xs-2">
					<button type="button" id="submitForm" class="btn btn-primary btn-sm">拒绝</button>
				</div>
				<div class="col-xs-2">
