...
<script type="text/javascript" src="resources/system/bas/course/course.js"></script>
...
<body>
	<div class="panel-body">
		...
		<div id=tb_course_toolbar></div>
		<table id="tb_course"></table>
	</div>
	<script type="text/javascript">
		$(function() {
			var imgBasePath = "<%=imgBasePath%>";
			var obj = new Course(imgBasePath);
			obj.init();
		});
	</script>
</body>
