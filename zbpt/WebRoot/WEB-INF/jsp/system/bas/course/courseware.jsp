...
<script type="text/javascript" src="resources/system/bas/course/courseware.js"></script>
...
<body>
	<div class="panel-body">
		<div id="search_form" class="panel panel-default">
			...
			<div class="panel-body">
				<form id="formSearch" class="query-form">
					...
					<div class="col-sm-2">
						<input type="hidden" class="form-control" id="search_course_id" name="search_course_id"> <input type="text"
		...
		<div id=tb_courseware_toolbar></div>
		<table id="tb_courseware"></table>
	</div>
	<script type="text/javascript">
		...
		this.ckplayer = function(path, name) {
			...
			var obj = new Courseware(imgBasePath);
			obj.init();
