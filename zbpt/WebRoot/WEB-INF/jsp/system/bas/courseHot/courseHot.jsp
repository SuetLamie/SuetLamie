...
<script type="text/javascript" src="resources/system/bas/courseHot/courseHot.js"></script>
...
<body>
	<div class="panel-body">
		...
		<div id=tb_course_hot_toolbar></div>
		<table id="tb_course_hot"></table>
	</div>
	<script type="text/javascript">
		$(function() {
			var obj = new CourseHot();
			obj.init();
		});
	</script>
</body>
