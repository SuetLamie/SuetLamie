...
<script type="text/javascript" src="resources/system/bas/courseHot/courseHotAdd.js"></script>
...
<body>
	<div class="panel-body">
		...
		<div id=tb_course_hot_add_toolbar></div>
		<table id="tb_course_hot_add"></table>
		
		
		<form role="form" class="form-horizontal" id="courseHotAddForm" method="post" >
