...
<script type="text/javascript" src="resources/system/bas/courseTeacher/courseTeacherAdd.js"></script>
...
<body>
	<div class="panel-body">
		<div id="search_form" class="panel panel-default">
			<div class="panel-body">
				<form id="formSearch" class="query-form">
						<label class="control-label col-sm-2">课程标题</label>
						<div class="col-sm-2">
		...
		<div id=tb_course_teacher_add_toolbar></div>
		<table id="tb_course_teacher_add"></table>
		
		
		<form role="form" class="form-horizontal" id="courseteacherAddForm" method="post" >
