...
<script type="text/javascript" src="resources/system/bas/appResourcesConfig/appResourcesConfigAdd.js"></script>

</head>
<body>
	<div class="bootstrap-form">
		<form role="form" class="form-horizontal" id="appResourcesConfigForm" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="control-label col-xs-3 form-lable">资源：</label>
				<div class="col-xs-9">
