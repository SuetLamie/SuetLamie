...
<script type="text/javascript" src="resources/system/bas/appResourcesConfig/appResourcesConfig.js"></script>
...
<body>
	<div class="panel-body">
		<div id="search_form" class="panel panel-default">
			...
			<div class="panel-body">
				<form id="formSearch" class="query-form">
					...
					<label class="control-label col-sm-1">页面标记</label>
					<div class="col-sm-2">
						<select class="form-control" id="search_page">
						</select>
					</div>
		...
		<div id=tb_app_resources_config_toolbar></div>
		<table id="tb_app_resources_config"></table>
	</div>
	<script type="text/javascript">
		$(function() {
			var obj = new AppResourcesConfig();
			obj.init();
		});
	</script>
</body>
