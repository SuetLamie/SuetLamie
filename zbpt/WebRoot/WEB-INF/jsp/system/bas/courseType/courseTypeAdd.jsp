...
<script type="text/javascript" src="resources/system/bas/courseType/courseTypeAdd.js"></script>

</head>
<body>
	<div class="bootstrap-form">
		<form role="form" class="form-horizontal" id="courseTypeForm" >
			<div class="form-group">
				<label class="control-label col-xs-3 form-lable">课程类别：</label>
				<div class="col-xs-9">
					<select class="form-control" id="dict_parent_id" name="dict_parent_id">
					</select>
				</div>
			</div>
			<div class="form-group">
	...
	<!-- 		<div class="form-group">
				...
				<div class="col-xs-9">
					<input type="number" class="form-control" id="dict_detail_order" name="dict_detail_order">
				</div>
			</div> -->
