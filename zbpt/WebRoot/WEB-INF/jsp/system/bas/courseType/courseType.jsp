...
<script type="text/javascript" src="resources/system/bas/courseType/courseType.js"></script>
...
<body>
	<div class="panel-body">
		<div id="search_form" class="panel panel-default">
			...
			<div class="panel-body">
				<form id="formSearch" class="query-form">
					<label class="control-label col-sm-1">课程类别</label>
					<div class="col-sm-2">
						<select class="form-control" id="search_level">
						</select>
					</div>
					<label class="control-label col-sm-1">子类别名称</label>
					<div class="col-sm-2">
		...
		<div id=tb_course_type_toolbar></div>
		<table id="tb_course_type"></table>
	</div>
	<script type="text/javascript">
		$(function() {
			var obj = new CourseType();
			obj.init();
		});
	</script>
</body>
