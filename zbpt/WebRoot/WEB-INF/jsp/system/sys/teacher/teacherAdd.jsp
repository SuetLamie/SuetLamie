...
<script type="text/javascript" src="resources/system/sys/teacher/teacherAdd.js"></script>
<script>
...
<%=htmlData%>
	<div class="bootstrap-form">
		<form role="form" class="form-horizontal" id="teacherForm" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="control-label col-xs-3 form-lable">封面形象：</label>
				<div class="col-xs-9">
					<input type="file" id="pathFile" name="pathFile">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-xs-3 form-lable">首页展示：</label>
				<div class="col-xs-9">
					<select class="form-control" name="commond">
