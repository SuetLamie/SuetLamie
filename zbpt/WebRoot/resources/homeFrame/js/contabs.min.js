$(function() {
			...
			function c() {
				...
				if (k) {
					var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o_id + '">' + l
							+ ' <i class="fa fa-times-circle"></i></a>';
					$(".J_menuTab").removeClass("active");
					var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o
							+ '" frameborder="0" data-id="' + o_id + '" seamless></iframe>';
			...
			// $(".J_menuItem").on("click", c);//不能动态绑定事件
			...
			// 刷新当前页面
			$(".J_tabReloadPage").on("click", function() {
						var dataId = $('.J_menuTabs .active').attr("data-id");
						var l = $('.J_iframe[data-id="' + dataId + '"]');
						var k = l.attr("src");
						l.attr("src", k);
					});
