package com.surpass.orc.core;

import static com.surpass.orc.core.CoreFunc.features;
...
import com.surpass.orc.util.Convert;
...
public class CharsIdentify {
	...
	private String path = new File(URLDecoder.decode(CharsIdentify.class.getResource("/config/orc/model/ann.xml").getPath())).getPath();;
	...
	private final String strChinese[] = { "zh_cuan" /* 川 */, "zh_e" /* 鄂 */, "zh_gan" /* 赣 */, "zh_gan1"/* 甘 */, "zh_gui"/* 贵 */,
			"zh_gui1"/* 桂 */, "zh_hei" /* 黑 */, "zh_hu" /* 沪 */, "zh_ji" /* 冀 */, "zh_jin" /* 津 */, "zh_jing" /* 京 */, "zh_jl" /* 吉 */,
			"zh_liao" /* 辽 */, "zh_lu" /* 鲁 */, "zh_meng" /* 蒙 */, "zh_min" /* 闽 */, "zh_ning" /* 宁 */, "zh_qing" /* 青 */,
			"zh_qiong" /* 琼 */, "zh_shan" /* 陕 */, "zh_su" /* 苏 */, "zh_sx" /* 晋 */, "zh_wan" /* 皖 */, "zh_xiang" /* 湘 */, "zh_xin" /* 新 */,
