 ...
 */
@Controller
@RequestMapping("system/bas/coursehot")
public class CourseHotController extends BaseController implements Serializable {
	...
	private static final Logger LOG4J = LoggerFactory.getLogger(CourseHotController.class);

	@Autowired
	private CourseHotService service;
	...
	public String queryMain() {
		return Constants.path.RETURN_PATH_SYSTEM + "bas/courseHot/courseHot.jsp";
	}
...
//		obj.setAct_user_id(accountUserId);
	...
	@RequestMapping("add")
	@ResponseBody
	public ResultMsg add(CourseHot obj) {
